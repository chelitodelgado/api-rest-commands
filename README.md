...
- Consulta mas de 400 comandos para linux, estos comandos son los mas utilizados por un usuario comun y experto.

- Se catalogan por categorias las cuales cuentas con su comando y una breve descripción.

- Cuenta con un sistema de paginación utilizando mongoose paginate v2.

- Esta es una versión beta por lo tanto falta integrar mas comandos a la API.
